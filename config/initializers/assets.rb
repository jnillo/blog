...
Rails.application.config.assets.precompile += %w( patricia_carmona_colors.scss patricia_carmona.scss modal_link_observer.js.coffee font-families.css mobile.scss patricia_carmona_mobile.scss jquery.inifinitescroll.js infinite_scroll.js audio.min.js podcasts.css podcasts_mobile.css)
