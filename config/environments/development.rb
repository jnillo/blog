Rails.application.configure do
  ...
  config.action_controller.default_url_options = { host: 'blog.dev' }
  ...
  config.assets.precompile += %w( patricia_carmona_colors.scss patricia_carmona.scss modal_link_observer.js.coffee font-families.css mobile.scss patricia_carmona_mobile.scss infinite_scroll.js jquery.inifinitescroll.js)
  ...
  config.action_mailer.default_url_options = { :host => 'patriciacarmona.com' }
  ...
  config.action_mailer.smtp_settings = {
      ...
      :password             => ENV['EMAIL_SENDER_PASS'],
